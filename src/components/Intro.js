  ...
  return(
    <Flex direction="column" align="center" justifyContent='center' >
      ...
      <Flex direction='column' align='center' zIndex='2'>
        ...
        <Button onClick={toggleWorks} w={{base: "100px", md: "200px"}} mt={{base: "20px", md: "40px"}} _focus={{border: "none"}} _hover={{bg: "rgba(156, 168, 184, 1)"}} _active={{bg: "rgba(134, 150, 167, 1)"}} bg={useColorModeValue("rgba(193, 203, 215, 1)", "#656176")}>Works</Button>
      </Flex>
    </Flex>
  )
}
