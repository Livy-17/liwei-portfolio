...
const Navbar = props => {
  ...
  return(
    <Box display="flex" alignItems="center" position="fixed" top="0" as="nav" w="100vw" h="60px" bg={useColorModeValue("rgba(252, 248, 238, 0.2)", "")} sx={isFirefox ? {bg: ""} : {backdropFilter: "blur(10px)"}} zIndex={99}>
      <Heading as="a" href="liweichen.info" size='md' p="10px 10px 10px 10px" display="inline-block" mr="auto" ml={{base: "20px", md: "60px"}} _hover={{cursor: "pointer"}} >Liwei Chen</Heading>
