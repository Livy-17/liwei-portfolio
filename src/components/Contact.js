...
const Contact = props => {
  return (
    <Flex id='contactSection' direction="column" align="center" p={{base: "60px 0 60px 0", md: "160px 0 160px 0"}}>
      ...
      <Box data-aos='zoom-in' border="solid 1px gray" borderRadius="5px" p="30px 20px 30px 20px" w={{base: "300px", md: "760px"}} >
        <FormControl>
